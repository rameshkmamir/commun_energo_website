...
urlpatterns = [
    ...
    path('conversations/<int:conversation_id>/update-conversation-user/', views.update_conversation_user,
         name='update_conversation_user'),
    path('conversations/<int:conversation_id>/update-conversation-status/', views.update_conversation_status,
